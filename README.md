...
* **Markdown Notes**: Display personal notes and articles fetched from an Airtable base. Content is rendered in-browser using a custom JavaScript function.
* **Combined RSS Feeds**: Fetches and merges content from multiple Google Alerts RSS feeds. The logic filters content from one feed to remove duplicates and enrich the other, providing a unified stream of news.
...
* **Libraries**:
    ...
    * `airtable`: Connects to and fetches data from the Airtable API.
